...
export function About() {
  return (
    <section
      ...
      data-section="about"
      aria-label="About"
      className="relative overflow-hidden rounded-t-[32px] rounded-b-[32px] px-6 pt-32 pb-32 md:rounded-t-[56px] md:rounded-b-[56px] md:px-12 md:pt-44 md:pb-44 lg:px-20"
      style={{
