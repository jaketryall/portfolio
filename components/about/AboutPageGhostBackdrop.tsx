...
/**
 * Page-level ABOUT ghost — reveals on mount (not on scroll), since it's
 * the page's primary anchor at the top of viewport.
 */
export function AboutPageGhostBackdrop() {
